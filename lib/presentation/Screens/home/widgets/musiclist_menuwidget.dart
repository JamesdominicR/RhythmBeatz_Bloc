...
import 'package:rhythm_beatz_bloc/presentation/Screens/home/widgets/add_playlist_widget.dart';

import '../../../../database/songmodel_adaptor.dart';

class MusiclistMenuWidget extends StatelessWidget {
  final String songID;
  MusiclistMenuWidget({Key? key, required this.songID}) : super(key: key);
      ...
      onSelected: (value) async {
        if (value == "1") {
          showModalBottomSheet(
            context: context,
            builder: (context) => AddPlaylistWidget(song: temp),
          );
        }
      },
    );
